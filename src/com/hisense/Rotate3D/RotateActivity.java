...
public class RotateActivity extends Activity implements OnTouchListener  
{
			...
			smallIcon.setOnClickListener(new View.OnClickListener() 
			{
				public void onClick(View arg0) 
				{
					...
					if(areButtonsShowing)
					{
						...
						{
							Log.d("ffffffff","position:"+position);
							Log.d("ffffffff","j:"+j);
							if(j != position)
							{
	...
	private void endRotateByVelocity()
	{
		if(degree > 0)
		{
			Log.d("wwwwwwwwww","currentTab:"+currentTab);
			rotate3d = new Rotate3D(degree , 90 , 0, mCenterX, mCenterY,"rotate3d");
			rotate3d3 = new Rotate3D( - 90 + degree,0,0, mCenterX, mCenterY,"rotate3d3");
		...
		{
			Log.d("wwwwwwwwww0000","currentTab:"+currentTab);
			rotate3d = new Rotate3D(degree , -90 , 0, mCenterX, mCenterY,"rotate3d");
			rotate3d2 = new Rotate3D( 90 + degree,0,0, mCenterX, mCenterY,"rotate3d2");
			rotate3d.setDuration(300);
	...
	private void endRotate() 
	{
		...
		{
			Log.d("uuuuu","currentTab:"+currentTab);
			rotate3d = new Rotate3D( degree , 0 , 0, mCenterX, mCenterY,"rotate3d");
			rotate3d2 = new Rotate3D(  90 + degree,90,0, mCenterX, mCenterY,"rotate3d2");
			rotate3d3 = new Rotate3D(  - 90 + degree,- 90,0, mCenterX, mCenterY,"rotate3d3");
	...
	private void doRotate(int dx) 
	{
		...
		degree += perDegree*dx;
		System.out.println("0>>>>>>>>>degree:" + degree );
		Log.d("qqqqqqqqqqqqqqqqqqqqqqqqqq001","counti:"+counti);
//		if(counti == 1)
//		{
		rotate3d = new Rotate3D(xd , degree , 0, mCenterX, mCenterY,"rotate3d111_"+counti);
		rotate3d2 = new Rotate3D( 90 + xd,  90+degree,0, mCenterX, mCenterY,"rotate3d222_"+counti);
		rotate3d3 = new Rotate3D(-90+xd, -90+degree,0, mCenterX, mCenterY,"rotate3d333_"+counti);
	
		
//		rotate3d.setDuration(1000);
//		rotate3d2.setDuration(10000);  
//		rotate3d3.setDuration(10000);  
		Log.d("qqqqqqqqqqqqqqqqqqqqqqqqqq","currentTab:"+currentTab);
		if(currentTab == 0)
		{  
			Log.d("bbbbbbbbbbbbbbbb","currentTab999999:"+currentTab);
			layoutmain.startAnimation(rotate3d);
			layoutnext.startAnimation(rotate3d2);
			layoutlast.startAnimation(rotate3d3);
		}
